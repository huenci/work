...
public class Sha1Util {
	 ...
	 * 
	 */
	public static final String APPID =WeChatConstans.appId;
	 ...
	 * 
	 */
	public static final String APPSECRET = WeChatConstans.appSecret;
	 ...
	 * 微信端支付成功回调地址
	 */
	public static final String WECHAT_NOTIFY_URL = "weChatPay/weChatPayResSample";
	...
	public static String getTimeStamp() {
	 ...
	 /**
		...
		public static String getPackage(WxPayDto tpWxPayDto,String basePath) {
			...
			logger.info("appid：" + APPID + ",appsecret：" + APPSECRET+ ",partnerkey：" + KEY + "");
