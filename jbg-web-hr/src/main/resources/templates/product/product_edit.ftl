...
<form class="layui-form" id="productForm" action="">
    ...
    <input type="hidden" name="surplusNumber" id = "surplusNumber">
	...
	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input type="radio" name="isRecommend" value="0" lay-filter="recod" title="否" checked="">
	      <input type="radio" name="isRecommend" value="1" lay-filter="recod" title="是">
	    </div>
	</div>
	<div id = "bqStatus">
...
<script>
    layui.use(['form','upload','laydate'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
        	debugger;
        	var surplusNumber = data.field.surplusNumber;
        	if(data.field.productNumber <= surplusNumber){
        		layer.msg("该商品已订购了"+surplusNumber+"份，库存数量不能低于"+surplusNumber);
        		return false;
        	}
